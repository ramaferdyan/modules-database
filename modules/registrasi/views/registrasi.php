                    ...
                    <div class="col-lg">
                        <div class="p-5">
                            ...
                            <form method="post" action="<?php echo base_url('registrasi/index') ?>" class="user">
                                ...
                                <div class="form-group">
                                    <input type="text" class="form-control form-control-user" id="exampleInputEmail" placeholder="Email Anda" name="email">
                            ...
                            <div class="text-center">
                                <a class="small" href="<?php echo base_url('auth/login') ?>">Sudah Punya Akun? Silhakan Login!</a>
                            </div>
                        </div>
                    </div>
                </div>
